...
import DropdownHelp from "../global/DropdownHelp";
import DropdownNotifications from "../global/DropdownNotifications";
import DropdownProfile from "../global/DropdownProfile";

function Header({ sidebarOpen, setSidebarOpen }) {
  const { firstName, email, accountId, status } = useAuth();
