...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  //   useCloseClickedOutSide(sidebar, trigger, sidebarOpen, setSidebarOpen);

  //   // close if the esc key is pressed
  //   useCloseESCPressed(sidebarOpen, setSidebarOpen);
    ...
    <div>
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          {/* Logo */}
          <NavLink end to="/app" className="block">
              ...
              >
                <NavLink
                  ...
                  className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                    pathname === "/app" && "hover:text-slate-200"
                  }`}
                >
                    ...
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      <path
                        className={`fill-current text-slate-400 ${
                          pathname === "/app" && "!text-indigo-500"
                        }`}
                        d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0z"
                      />
                      <path
                        className={`fill-current text-slate-600 ${
                          pathname === "/app" && "text-indigo-600"
                        }`}
                        d="M12 3c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9z"
                      />
                      <path
                        className={`fill-current text-slate-400 ${
                          pathname === "/app" && "text-indigo-200"
                        }`}
